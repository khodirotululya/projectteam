...
class LaporanBos extends CI_Controller {

	private $parents = 'LaporanBos';
	...
	function Cetak(){
		 ...
		 $a = $this->db->get('laporanbos')->result();
		...
		$this->breadcrumb->append_crumb($this->parents.' Kas',base_url('LaporanBos'));
		...
		$data['icon']	= $this->icon;
		$data['isi']	= $this->M_Tap->get_laporanbos($id);
